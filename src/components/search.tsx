										...
										<div className="flex gap-3 items-center">
											<div className="relative flex-1">
												...
												<input
													...
													className="w-full pl-12 pr-4 py-3 bg-[#f4f4f4] border border-[#010100] rounded-lg focus:outline-none  transition-all duration-150"
												/>
											</div>
											<button
												type="submit"
												className="bg-[#010100]  text-white px-6 py-3 rounded-md transition-colors duration-150 font-medium disabled:opacity-50 disabled:cursor-not-allowed"
													...
													<div className="flex gap-2 flex-wrap">
														{recentSearches.map(({ query }) => (
															<button
																...
																className="px-4 py-2 bg-[#f4f4f4] hover:bg-[#e4e4e4] rounded-md text-sm text-gray-700 transition-colors duration-150"
															>
																{query}
															</button>
														))}
