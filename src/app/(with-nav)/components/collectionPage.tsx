...
export default function CollectionPage() {
    ...
    }, [category, minPrice, maxPrice, sortBy, onSale, isNew, model, discountRange]);
    ...
    const availableModels = ['iPhone 13', 'Samsung Galaxy S22', 'Google Pixel 7'];
    const availableDiscounts = [10, 20, 30, 50];
